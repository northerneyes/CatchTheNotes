...
public class PauseMenu {
    ...
    {
        return MyGame.getAppContext().getString(R.string.resume_menu);
    }

    public String getRestartText()
    {
        return MyGame.getAppContext().getString(R.string.restart_menu);
    }

    public String getEndGameText()
    {
        return MyGame.getAppContext().getString(R.string.end_game_menu);
    }
